        ...
        Row![  // s().flex("1 1 0%").min_height(px(0)),
            Column![ 
                ...
                textarea![ 
                    ...
                    s().font_family("'Lucida Console', Monaco, monospace").p(px(4)).b_color("gray").b_width(px(1)).b_style_solid().w(pc(100)).h(pc(100)),
                    attrs!{At::Type => "textbox"},  
                    input_ev(Ev::Input, |s| md_source().set(s.to_string())),
...
fn fancy_button_view<Ms>(args: AdditionalStyle, mut root: Node<Ms>, children: Vec<Node<Ms>> )-> Node<Ms>{
    as_tag![
        ...
        .margin(px(8))
        .my(px(20))
        .font_size(&[px(16), px(24)]).background_color("gray")
            .border_radius(px(3))
            .outline_none(),
        s().hover()
                    ...
                    Row![
                        Item![ align = RowAlign::Right,
                            button![
                                ...
                                ,
                                mouse_ev(Ev::Click , |_| show_editor().set(false)),
                                "Close"
                            ],
                    ]]]
                ]]
...
fn if_example() -> Node<Msg> {
    ...
    div![
        "A:",
        input![bind(At::Value, input_a),   s().border_color("gray").radius(px(4)).border_width(px(1)).py(px(4)),],
        "B:",
        input![bind(At::Value, input_b),  s().border_color("gray").radius(px(4)).border_width(px(1)).py(px(4)),],
...
"Here is an example of what we will create: ", fancy_button!["Example", mouse_ev(Ev::Click, |_| show_editor().set(true))]
